...
class AIAgent(IAgent):
    ...
    def add_to_history(self, move: List):
        ...
        are_move_dirs_the_same = (
                previous_move_vector[0] == move[0] and previous_move_vector[1] == move[1] and previous_move_vector[2] ==
                move[2] and previous_move_vector[3] == move[3]
        )
    ...
    def get_game_data(self, game):
        ...
        death_tensor = torch.tensor(
            [left_death / map_size_x, right_death / map_size_x, up_death / map_size_y, down_death / map_size_y],
        ...
        for food in closest_food_objects:
            ...
            closest_food_positions.append((food_x - snake_x) / map_size_x)
            closest_food_positions.append((food_y - snake_y) / map_size_y)
            closest_food_positions.append(1)

        while len(closest_food_positions) < _tracked_food_count*3:
            for i in range(0, 3):
                closest_food_positions.append(0)
